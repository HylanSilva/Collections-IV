...
public class xemploHashMap {
	...
	public static void main(String[] args) {
		...
		//Retorna se exise ou não alguma seleção hexacampeã
		...
		System.out.println(campeoesMundialFifa.size()); // Antes
		
		campeoesMundialFifa.clear(); // Ação de limpar
		
		System.out.println(campeoesMundialFifa.size()); // Depois
